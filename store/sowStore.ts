...
interface SOWStore {
  ...
  clientLogoDataUrl: string | null; // Client logo as data URL
  ...
  setClientLogo: (logoDataUrl: string | null) => void;
}
...
export const useSOWStore = create<SOWStore>()(
  persist(
    (set, get) => ({
      ...
      recentFiles: [
        {
          ...
          size: "245 KB",
          content:
            "<h1>Project Alpha Statement of Work</h1><p>This document outlines the scope of work...</p>",
        },
        {
          id: "2",
          ...
          size: "189 KB",
          content:
            "<h1>Client Beta Proposal</h1><p>Project overview and deliverables...</p>",
        },
        {
          id: "3",
          ...
          size: "312 KB",
          content:
            "<h1>Q4 Deliverables</h1><p>Quarterly objectives and milestones...</p>",
        },
      ],
      ...
      setClientLogo: (logoDataUrl) => set({ clientLogoDataUrl: logoDataUrl }),
